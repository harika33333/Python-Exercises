...
def list_manip(my_list):
    s=f"Initial list: {my_list}\n"
    my_list[1]=200
    s=s+f"After changing second element: {my_list}\n"
    my_list.append(600)
    s=s+f"List after appending 600: {my_list}\n"
    my_list.insert(2,300)
    s=s+f"List after inserting 300 at index 2: {my_list}\n"
    my_list.remove(600)
    s=s+f"List after removing 600 (by value): {my_list}\n"
    my_list.pop(0)
    s=s+f"List after removing element at index 0: {my_list}\n"
    return(s)
print(list_manip(my_list))
